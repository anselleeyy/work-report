						...
						<table id="td_table">
							<tbody id="n">
						  		...
						  		<tr align="center">
						  			...
						  			<td id="td">
										<textarea style="resize:none; margin-top: 5px;" disabled="disabled" rows="1" cols="67" name="precdt"><s:property value="#pts.cdtask"/></textarea>
									</td>
						  			<td id="td" style="border-right: thin dashed gray;">
										<input name="prerq1" id="d4311" value="<s:property value="#pts.wcrq"/>" class="Wdate" disabled="disabled" type="text" onFocus="f1();" style="height: 33px; width:175px; margin-top: 4px; font-size: 21px; "/>
