  		...
  		<form action="" method="post" name="form1">
			...
			<table id="subtree1" width="1100px;">
				...
				<tr>
					...
					<td id="td" bgcolor="#63ebfb">年度</td>
					<td id="td" style="border-right: thin dashed gray;">&nbsp;&nbsp;${hb.zyys}年</td>
				</tr>
				<tr>
					<td id="td" bgcolor="#63ebfb">上年度工作重点</td>
						...
						<table id="td_table">
							<tbody id="n">
						  		...
						  		<tr align="center">
						  			...
						  			<td id="td" style="border-right: thin dashed gray;">
										<input name="prerq1" disabled="disabled" id="d4311" value="<s:property value="#pts.wcrq"/>" class="Wdate" type="text" onFocus="f1();" style="height: 33px; width:175px; margin-top: 4px; font-size: 21px; "/>
										<div style="display: none;">
											<input name="returnDate" id="d4312" class="Wdate" type="text" onFocus="f2();" style="height: 33px; width:175px; margin-top: 23px; font-size: 21px;"/>
										</div>
									</td>
						  		</tr>
						  		</s:iterator>
				...
				<tr>
					<td id="td" bgcolor="#63ebfb">下年度计划工作重点</td>
					<td id="td" style="border-right: thin dashed gray;" colspan="3">
						<table id="td_table">
							<tbody id="n2">
								<tr align="center">
								...
								<tr align="center">
						  			...
						  			<td id="td">
										<input name="nextwcDate" id="d4311" class="Wdate" type="text" onFocus="f1();" style="height: 33px; width:145px; margin-top: 4px; font-size: 21px; "/>
									</td>
									<td id="td">
										<select name="nextzrren">
											<s:iterator value="users" status="status" var="users">
